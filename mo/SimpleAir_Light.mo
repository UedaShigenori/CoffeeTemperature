...
<pre>
 ...
 BaOH      C2H4            DCl             In2I2   Na3F3    ScO+
  ...
  package SimpleAir "Air: Simple dry air model (0..100 degC)"
    ...
    constant Modelica.Media.Interfaces.Types.Basic.FluidConstants[nS] airConstants = {Modelica.Media.Interfaces.Types.Basic.FluidConstants(iupacName = "simple air", casRegistryNumber = "not a real substance", chemicalFormula = "N2, O2", structureFormula = "N2, O2", molarMass = SingleGasesData_copy.N2.MM)} "Constant data for the fluid";
    annotation(
      Documentation(info = "<html>
