...
model HeatedPipeBiDirection "A simple static pipe with heating/cooling"
...
// Energy balance
  ...
  port_a.h_outflow = inStream(port_b.h_outflow) + heatPort.Q_flow/port_b.m_flow;
  
  semiLinear(port_a.m_flow, port_b.h_outflow, -port_a.h_outflow) = heatPort.T*medium.cp;
...
//     Q_flow "This equation is only 'active' when flow enters port_b and leaves port_a";
  annotation(
    preferredView = "text",
    Icon(coordinateSystem(preserveAspectRatio = false, initialScale = 0.1), graphics = {Rectangle(lineColor = {28, 108, 200}, fillColor = {28, 108, 200}, fillPattern = FillPattern.Solid, extent = {{-100, 40}, {100, -40}}), Rectangle(fillColor = {215, 215, 215}, fillPattern = FillPattern.Backward, extent = {{-100, 60}, {100, 40}}), Rectangle(fillColor = {215, 215, 215}, fillPattern = FillPattern.Backward, extent = {{-100, -40}, {100, -60}}), Line(points = {{-40, -80}, {40, -80}}), Line(points = {{30, -74}, {40, -80}, {30, -86}}), Line(origin = {-0.307208, -159.937}, rotation = 180, points = {{30, -74}, {40, -80}, {30, -86}})}),
